...
Source: "{#Root}\out\build\{#BuildCfg}\cmd\os\windows\kstat\kstat.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "{#Root}\out\build\{#BuildCfg}\cmd\os\windows\zfsinstaller\zfsinstaller.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "{#Root}\out\build\{#BuildCfg}\cmd\os\windows\zed_service\zed_service.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "{#Root}\out\build\{#BuildCfg}\cmd\os\windows\zfs_tray\zfs_tray.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "{#Root}\out\build\{#BuildCfg}\cmd\zpool\zpool.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "{#Root}\out\build\{#BuildCfg}\cmd\zfs\zfs.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "{#Root}\out\build\{#BuildCfg}\cmd\zdb\zdb.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "{#Root}\out\build\{#BuildCfg}\cmd\zed\zed.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "{#Root}\out\build\{#BuildCfg}\cmd\zstream\zstreamdump.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "{#Root}\out\build\{#BuildCfg}\cmd\raidz_test\raidz_test.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "{#Root}\out\build\{#BuildCfg}\module\os\windows\driver\OpenZFS.sys"; DestDir: "{app}"; Flags: ignoreversion
Source: "{#Root}\out\build\{#BuildCfg}\module\os\windows\driver\OpenZFS.cat"; DestDir: "{app}"; Flags: ignoreversion
Source: "{#Root}\out\build\{#BuildCfg}\module\os\windows\driver\OpenZFS.inf"; DestDir: "{app}"; Flags: ignoreversion
Source: "{#Root}\out\build\{#BuildCfg}\module\os\windows\driver\OpenZFS.man"; DestDir: "{app}"; Flags: ignoreversion
...
Source: "{#Root}\out\build\{#BuildCfg}\module\os\windows\driver\*.pdb"; DestDir: "{app}\symbols"; Flags: ignoreversion
Source: "{#Root}\out\build\{#BuildCfg}\cmd\zstream\*.pdb"; DestDir: "{app}\symbols"; Flags: ignoreversion
Source: "{#Root}\out\build\{#BuildCfg}\cmd\zpool\*.pdb"; DestDir: "{app}\symbols"; Flags: ignoreversion
Source: "{#Root}\out\build\{#BuildCfg}\cmd\zfs\*.pdb"; DestDir: "{app}\symbols"; Flags: ignoreversion
Source: "{#Root}\out\build\{#BuildCfg}\cmd\zdb\*.pdb"; DestDir: "{app}\symbols"; Flags: ignoreversion
Source: "{#Root}\out\build\{#BuildCfg}\cmd\zed\*.pdb"; DestDir: "{app}\symbols"; Flags: ignoreversion
Source: "{#Root}\out\build\{#BuildCfg}\cmd\raidz_test\*.pdb"; DestDir: "{app}\symbols"; Flags: ignoreversion
Source: "{#Root}\out\build\{#BuildCfg}\cmd\os\windows\zfsinstaller\*.pdb"; DestDir: "{app}\symbols"; Flags: ignoreversion
Source: "{#Root}\out\build\{#BuildCfg}\cmd\os\windows\kstat\*.pdb"; DestDir: "{app}\symbols"; Flags: ignoreversion
...
Source: "{#Root}\out\build\{#BuildCfg}\module\os\windows\zvol\driver\OpenZVOL.sys"; DestDir: "{app}"; Flags: ignoreversion
Source: "{#Root}\out\build\{#BuildCfg}\module\os\windows\zvol\driver\OpenZVOL.cat"; DestDir: "{app}"; Flags: ignoreversion
Source: "{#Root}\out\build\{#BuildCfg}\module\os\windows\zvol\driver\OpenZVOL.inf"; DestDir: "{app}"; Flags: ignoreversion
Source: "{#Root}\out\build\{#BuildCfg}\module\os\windows\zvol\driver\*.pdb"; DestDir: "{app}\symbols"; Flags: ignoreversion
; VSS provider (enables Previous Versions for ZFS snapshots)
Source: "{#Root}\out\build\{#BuildCfg}\cmd\os\windows\zfs_vss_provider\zfs_vss_provider.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "{#Root}\out\build\{#BuildCfg}\cmd\os\windows\zfs_vss_provider\*.pdb"; DestDir: "{app}\symbols"; Flags: ignoreversion
